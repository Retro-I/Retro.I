                ...
                with_scrollbar_space(
                    ft.ListView(
                        ...
                        controls=[
                            ...
                            ft.Text(
                                spans=[
                                    ft.TextSpan("Uploadrate: "),
                                    self.upload_rate_text,
                                    ft.TextSpan(" kB/s"),
                                ],
                                size=20,
                            ),
    ...
    def open_dialog(self):
        ...
        def _retrieve_system_info():
            while self.open:
                ...
                self.upload_rate_text.text = round(system_helper.get_upload_rate(), 2)
                self.upload_rate_text.update()
