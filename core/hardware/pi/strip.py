...
class PiStripHardware(BaseStripHardware):
    ...
    def __init__(self):
        ...
        start_color = (
            ...
            else PiStripHardware.curr_color
        )
    ...
    def callback(self):
        ...
        if not audio_helper.is_mute():
            ...
            self.pixels.fill(PiStripHardware.curr_color)
            self.pixels.show()
    ...
    def update_strip(self, color):
        ...
        PiStripHardware.curr_station_color = strip_color
        if not settings_helper.is_static_color():
            self.set_color(strip_color)

    def set_color(self, color):
        PiStripHardware.curr_color = color
